            ...
            <div className="animated fadeIn">
                <Row>
                    <Col xs="12" sm="12" lg="12">
                        <h2 style={{color:"grey"}}>Manage Staff</h2>
                    </Col>
                </Row>
                    ...
                    <Col>
                        <ul className="nav nav-tabs">
                            <li className="nav-item">
                                <a className={this.state.tabActive==0 ? "nav-link active" : "nav-link"} onClick={this.OnClickTabStaffList}><i class="fa fa-align-justify"></i> Staffs List</a>
                            </li>
                            <li className="nav-item">
                                <a className={this.state.tabActive==1 ? "nav-link active" : "nav-link"} onClick={this.OnClickTabAddStaff}><i class="fa fa-plus-circle fa-lg"></i> Add Staff</a>
                            </li>
                        </ul>
                    </Col>
                </Row>
