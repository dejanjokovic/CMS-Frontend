...
class ManageAttendance extends Component {
    ...
    componentDidMount(){
        this.setState({DepartmentList, FNStatusList, ANStatusList, LeaveStatusList, StaffAttendanceList})
    ...
    OnChangeDepartment(value) {this.setState({Department:value})}
        ...
        return (
            <div className="animated fadeIn">
                            ...
                            <DropdownMenu>
                                {
                                    this.state.DepartmentList.map((item, index) => {
                                        return (
                                            <DropdownItem key={index} onClick={()=>this.OnChangeDepartment(item)}>{item}</DropdownItem>
                                        )
                                    })
                                }
                            </DropdownMenu>
                ...
                <div style={{padding:30, textAlign:"center"}}>
                    ...
                    <Row className="text-center"><Col><h5>Attendance of Department English</h5></Col></Row>
