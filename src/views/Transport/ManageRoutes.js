            ...
            <div className="animated fadeIn">
                <Row>
                    <Col xs="12" sm="12" lg="12">
                        <h2 style={{color:"grey"}}>Manage Routes</h2>
                    </Col>
                </Row>
                    ...
                    <Col>
                        <ul className="nav nav-tabs">
                            <li className="nav-item">
                                <a className={this.state.tabActive==0 ? "nav-link active" : "nav-link"} onClick={this.OnClickTabRoutesList}><i class="fa fa-align-justify"></i> Routes List</a>
                            </li>
                            <li className="nav-item">
                                <a className={this.state.tabActive==1 ? "nav-link active" : "nav-link"} onClick={this.OnClickTabAddRoutes}><i class="fa fa-plus-circle fa-lg"></i> Add Routes</a>
                            </li>
                            <li className="nav-item">
                                <a className={this.state.tabActive==2 ? "nav-link active" : "nav-link"} onClick={this.OnClickTabRoutesReport}><i class="fa fa-plus-circle fa-lg"></i> Add Stops</a>
                            </li>
                        </ul>
                    </Col>
                </Row>
                                        ...
                                        </thead>
                                            {
                                                this.state.RoutesList.map((item, index) => {
                                                    ...
                                                    <tr key={index}>
                                                        ...
                                                        <td>
                                                            <Button color="primary">View Route</Button>
                                                        </td>
                                                    </tr>
                                                    )
                                                })
                        ...
                        <div className="card">
                            <div className="card-body">
                                <form action="" method="post" enctype="multipart/form-data" className="form-horizontal">
                                    <div className="position-relative row form-group">
                                        <div className="col-md-3"  style={{textAlign:"right", marginTop:4}}>
                                            <label for="name-input" className="">Route</label>
                                        </div>
                                ...
                                <Row>
                                    ...
                                    <Col lg="2">
                                        <Button block color="primary">Add Routes</Button>
                                    </Col>
                                </Row>
                            </div>
                        </div>
                    ...
                    <div className="card">
                        <div className="card-body">
                            <form action="" method="post" enctype="multipart/form-data" className="form-horizontal">
                                ...
                                <div className="position-relative row form-group">
                                    <div className="col-md-3"  style={{textAlign:"right", marginTop:4}}>
                                        <label for="name-input" className="">Stop Name</label>
                                    </div>
                                    <div className="col-12 col-md-5">
                                        <input id="name-input" name="name-input" placeholder="Name" type="text" className="form-control"/>
                                        {/* <small className="form-text text-muted">Name is required</small> */}
                                ...
                                <div className="position-relative row form-group">
                                    <div className="col-md-3"  style={{textAlign:"right", marginTop:4}}>
                                        <label for="name-input" className="">Bus Fare</label>
                                    </div>
                                    <div className="col-12 col-md-5">
                                        <input id="name-input" name="name-input" placeholder="Name" type="text" className="form-control"/>
                                        {/* <small className="form-text text-muted">Name is required</small> */}
