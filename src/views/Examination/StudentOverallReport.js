...
const Data = [
    {SubjectName:"Sini S", MaxMarkAndGrade:"Asst Prof", Attendance:75, ObtainedMark:75, Grade:"C", Status:"Passed", GradePoint:4, ObtainedMark2:50, Grade2:"D", GradePoint2:"2", AvgGrade2:2.5, Assignment2:18, Seminar2:9, OverallGradePont:26.5, OverallGrade:"F", Status:"Passed"},
    {SubjectName:"Sini S", MaxMarkAndGrade:"Asst Prof", Attendance:75, ObtainedMark:75, Grade:"C", Status:"Passed", GradePoint:4, ObtainedMark2:50, Grade2:"D", GradePoint2:"2", AvgGrade2:2.5, Assignment2:18, Seminar2:9, OverallGradePont:26.5, OverallGrade:"F", Status:"Passed"},
]
class StudentOverallReport extends Component {
    constructor(props) {
        super(props);
        this.state={
        }
            ...
            <div className="animated fadeIn">
                <Row>
                    <Col xs="12" sm="12" lg="12">
                        <h2 style={{color:"grey"}}>Overall Internal Mark Report</h2>
                    </Col>
                </Row>
                            ...
                            <Table responsive>
                                <thead>
                                    <tr>
                                        ...
                                        <th>Grade</th>
                                        <th>Grade Point</th>
                                        <th>Obtained Mark2</th>
                                        <th>Grade2</th>
                                        <th>Grade Point 2</th>
                                        <th>Avg Grade Point 2</th>
                                        <th>Assignment 2</th>
                                        <th>Seminar 2</th>
                                        <th>Attendance 2</th>
                                        <th>Overall Grade Point 2</th>
                                        <th>Overall Grade</th>
                                        <th>Status</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {
                                        Data.map((item, index) => (
                                            <tr>
                                                ...
                                                <td>{item.ObtainedMark2}</td>
                                                <td>{item.Grade2}</td>
                                                <td>{item.GradePoint2}</td>
                                                <td>{item.AvgGrade2}</td>
                                                <td>{item.Assignment2}</td>
                                                <td>{item.Seminar2}</td>
                                                <td>{item.Attendance}</td>
                                                <td>{item.OverallGradePont}</td>
