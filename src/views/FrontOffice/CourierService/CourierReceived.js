...
const CourierReceivedList = [
    {From:"Aswathy", Address:"Aswathy Nivas.Pariya", CourierContent:"For Scholarship fe", CourierReceiptNumber:"0", Date:new Date().toISOString()},
    {From:"Aswathy", Address:"Aswathy Nivas.Pariya", CourierContent:"For Scholarship fe", CourierReceiptNumber:"gigigi", Date:new Date().toISOString()},
    {From:"Aswathy", Address:"Aswathy Nivas.Pariya", CourierContent:"For Scholarship fe", CourierReceiptNumber:"0", Date:new Date().toISOString()},
    {From:"Aswathy", Address:"Aswathy Nivas.Pariya", CourierContent:"For Scholarship fe", CourierReceiptNumber:"0", Date:new Date().toISOString()},
    {From:"Aswathy", Address:"Aswathy Nivas.Pariya", CourierContent:"For Scholarship fe", CourierReceiptNumber:"0", Date:new Date().toISOString()},
]

class CourierReceived extends Component {
    constructor(props) {
        super(props);
        this.state={
            tabActive:0,
            ...
            CourierReceivedList: CourierReceivedList,
        }
    }

    loading = () => <div className="animated fadeIn pt-1 text-center">Loading...</div>

    OnClickTabCourierReceivedList = () => this.setState({tabActive:0})
    OnClickTabAddCourierReceived = () => this.setState({tabActive:1})
            ...
            <div className="animated fadeIn">
                <Row>
                    <Col xs="12" sm="12" lg="12">
                        <h2 style={{color:"grey"}}>Courier Received Details</h2>
                    </Col>
                </Row>
                    ...
                    <Col>
                        <ul className="nav nav-tabs">
                            <li className="nav-item">
                                <a className={this.state.tabActive==0 ? "nav-link active" : "nav-link"} onClick={this.OnClickTabCourierReceivedList}><i class="fa fa-align-justify"></i> Courier Received List</a>
                            </li>
                            <li className="nav-item">
                                <a className={this.state.tabActive==1 ? "nav-link active" : "nav-link"} onClick={this.OnClickTabAddCourierReceived}><i class="fa fa-plus-circle fa-lg"></i> Add Received</a>
                            </li>
                        </ul>
                    </Col>
                </Row>
                                ...
                                <div className="table-responsive">
                                    <table className="table">
                                        <thead>
                                            ...
                                            {
                                                this.state.CourierReceivedList.map((item, index) => {
                                                    return(
                                                    <tr key={index}>
                                                        <td>{index+1}</td>
                                                        <td>{item.From}</td>
                        ...
                        <div className="card">
                            <div className="card-body">
                                <form action="" method="post" enctype="multipart/form-data" className="form-horizontal">
                                    <div className="position-relative row form-group">
                                        <div className="col-md-3"  style={{textAlign:"right", marginTop:4}}>
                                            <label for="from-input" className="">From*</label>
                                        </div>
                                        <div className="col-12 col-md-5">
                                            <input id="from-input" name="from-input" placeholder="To" type="text" className="form-control"/>
                                            <small className="form-text text-muted">From is required</small>
                                        </div>
                                    </div>
                                    <div className="position-relative row form-group">
                                        <div className="col-md-3"  style={{textAlign:"right", marginTop:4}}>
                                ...
                                <Row>
                                    ...
                                    <Col lg="2">
                                        <Button block color="primary">Add Received</Button>
                                    </Col>
                                </Row>
                            </div>
                        </div>
...
export default CourierReceived;
