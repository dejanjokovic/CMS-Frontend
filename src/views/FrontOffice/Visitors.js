...
const visitorList = [
    {TypeOfVisiting:"to_meet_director", Name:"Devika.K R", Address:"Kaarikkal(h.o), Chelakkara(p.o), Thrissur Pin:580693", ContactNo:"982737289373", Purpose:"For check admission details", DateOfVisitAndTime:new Date().toISOString()},
    {TypeOfVisiting:"to_meet_director", Name:"Devika.K R", Address:"Kaarikkal(h.o), Chelakkara(p.o), Thrissur Pin:580693", ContactNo:"982737289373", Purpose:"For check admission details", DateOfVisitAndTime:new Date().toISOString()},
    {TypeOfVisiting:"to_meet_director", Name:"Devika.K R", Address:"Kaarikkal(h.o), Chelakkara(p.o), Thrissur Pin:580693", ContactNo:"982737289373", Purpose:"For check admission details", DateOfVisitAndTime:new Date().toISOString()},
    {TypeOfVisiting:"to_meet_director", Name:"Devika.K R", Address:"Kaarikkal(h.o), Chelakkara(p.o), Thrissur Pin:580693", ContactNo:"982737289373", Purpose:"For check admission details", DateOfVisitAndTime:new Date().toISOString()},
    {TypeOfVisiting:"to_meet_director", Name:"Devika.K R", Address:"Kaarikkal(h.o), Chelakkara(p.o), Thrissur Pin:580693", ContactNo:"982737289373", Purpose:"For check admission details", DateOfVisitAndTime:new Date().toISOString()},
...
class Visitors extends Component {
    constructor(props) {
        ...
        this.state={
            ...
            isOpenVisitorDropdown: false,

            typeOfVisiting:"Select",
        }
    }
    ...
    toggleVisitorDropdown(){this.setState({isOpenVisitorDropdown:!this.state.isOpenVisitorDropdown})}

    OnClickTabVisitorsList = () => this.setState({tabActive:0})
    OnClickTabAddVisitors = () => this.setState({tabActive:1})

    OnClickButtonFilter = () => {
        console.log(this.state.filterToDate)
    }

    OnChangeTypeOfVisiting(tv) {this.setState({typeOfVisiting:tv})}
            ...
            <div className="animated fadeIn">
                <Row>
                    <Col xs="12" sm="12" lg="12">
                        <h2 style={{color:"grey"}}>Manage Visitors</h2>
                    </Col>
                </Row>
                    ...
                    <Col>
                        <ul className="nav nav-tabs">
                            <li className="nav-item">
                                <a className={this.state.tabActive==0 ? "nav-link active" : "nav-link"} onClick={this.OnClickTabVisitorsList}><i class="fa fa-align-justify"></i> Visitors List</a>
                            </li>
                            <li className="nav-item">
                                <a className={this.state.tabActive==1 ? "nav-link active" : "nav-link"} onClick={this.OnClickTabAddVisitors}><i class="fa fa-plus-circle fa-lg"></i> Add Visitors</a>
                            </li>
                        </ul>
                    </Col>
                </Row>
                                ...
                                <div className="table-responsive">
                                    <table className="table">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Type Of Visiting</th>
                                                <th>Name</th>
                                                <th>Address</th>
                                                <th>Contact No</th>
                                                <th>Purpose</th>
                                                <th>DateOfVisitAndTime</th>
                                                <th>Options</th>
                                            </tr>
                                        </thead>
                                            {
                                                this.state.visitorList.map((item, index) => {
                                                    ...
                                                    <tr key={index}>
                                                        <td>{index+1}</td>
                                                        <td>{item.TypeOfVisiting}</td>
                                                        <td>{item.Name}</td>
                                                        <td>{item.Address}</td>
                                                        <td>{item.ContactNo}</td>
                                                        <td>{item.Purpose}</td>
                                                        <td>{item.DateOfVisitAndTime}</td>
                        ...
                        <div className="card">
                            <div className="card-body">
                                <form action="" method="post" enctype="multipart/form-data" className="form-horizontal">
                                    <div className="position-relative row form-group">
                                        <div className="col-md-3"  style={{textAlign:"right", marginTop:4}}>
                                            <label for="type-input" className="">Type Of Visiting*</label>
                                        </div>
                                        <div className="col-12 col-md-5">
                                            <Dropdown isOpen={this.state.isOpenVisitorDropdown} toggle={() => {this.toggleVisitorDropdown()}}>
                                                <DropdownToggle caret>
                                                    {this.state.typeOfVisiting}
                                                </DropdownToggle>
                                                <DropdownMenu>
                                                    <DropdownItem onClick={() => this.OnChangeTypeOfVisiting("To meet Director")}>To meet Director</DropdownItem>
                                                    <DropdownItem onClick={() => this.OnChangeTypeOfVisiting("To meet other staffs")}>To meet other staffs</DropdownItem>
                                                    <DropdownItem onClick={() => this.OnChangeTypeOfVisiting("To meet Students")}>To meet Students</DropdownItem>
                                                </DropdownMenu>
                                            </Dropdown>
                                        </div>
                                    </div>
                                ...
                                <Row>
                                    ...
                                    <Col lg="2">
                                        <Button block color="primary">Add Visitors</Button>
                                    </Col>
                                </Row>
                            </div>
                        </div>
