...
const StudentList = [
    {Gender:"Male", Name:"Devika.K R", Mobile:"982737289373", ExpansionOfInitials:"For check admission details", EmailId:"9809158380", Address:"Kaarikkal(h.o), Chelakkara(p.o), Thrissur Pin:580693"},
    {Gender:"Male", Name:"Devika.K R", Mobile:"982737289373", ExpansionOfInitials:"For check admission details", EmailId:"9809158380", Address:"Kaarikkal(h.o), Chelakkara(p.o), Thrissur Pin:580693"},
    {Gender:"Male", Name:"Devika.K R", Mobile:"982737289373", ExpansionOfInitials:"For check admission details", EmailId:"9809158380", Address:"Kaarikkal(h.o), Chelakkara(p.o), Thrissur Pin:580693"},
    {Gender:"Male", Name:"Devika.K R", Mobile:"982737289373", ExpansionOfInitials:"For check admission details", EmailId:"9809158380", Address:"Kaarikkal(h.o), Chelakkara(p.o), Thrissur Pin:580693"},
    {Gender:"Male", Name:"Devika.K R", Mobile:"982737289373", ExpansionOfInitials:"For check admission details", EmailId:"9809158380", Address:"Kaarikkal(h.o), Chelakkara(p.o), Thrissur Pin:580693"},
...
class StudentDetails extends Component {
    ...
    componentDidMount(){
        this.setState({StudentList, GenderList, JobTypeList, ActionsList})
                                        ...
                                        </thead>
                                            {
                                                this.state.StudentList.map((item, index) => {
                                                    ...
                                                    <tr key={index}>
                                                        <td>{index+1}</td>
                                                        <td>{item.Name}</td>
                                                        <td>{item.ExpansionOfInitials}</td>
                                                        <td>{item.Gender}</td>
                                                        <td>{item.Mobile}</td>
                                                        <td>{item.Address}</td>
                                                        <td>{item.Email}</td>
